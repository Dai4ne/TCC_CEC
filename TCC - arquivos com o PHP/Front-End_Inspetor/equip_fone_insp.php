...
/*
 * equip_fone_insp.php
 * - Propósito: listar equipamentos do tipo 'Fone' para inspetores.
...
// Consulta com JOIN para obter o nome da marca e somente Fones (tipo = 6)
$sql = "
            ...
            <div class="col-12 col-lg-3">
                <div class="bg-white rounded shadow-sm">
                    ...
                    <a href="equip_fone_insp.php">
                        <div class="equipment-item d-flex justify-content-between align-items-center active">
                            <span>FONES</span>
