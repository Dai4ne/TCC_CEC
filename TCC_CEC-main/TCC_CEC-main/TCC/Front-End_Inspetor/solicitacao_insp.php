...
<style>
    ...
    .btn-reject { 
        background: #e74c3c; color: white; border-radius: 6px; padding: 6px 15px; border: none; 
    }


    .btn-approve { 
        background: #27ae60; color: white; border-radius: 6px; padding: 6px 15px; border: none; 
    }
